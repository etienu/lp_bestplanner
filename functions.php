...
//  記事のアクセス制限処理
//  https://www.d-grip.com/blog/seisaku/50//
//  指定の投稿タイプのページにアクセスした際404に飛ばすリライト処理
add_filter( 'planner_rewrite_rules', '__return_empty_array' );
add_filter( 'reports_rewrite_rules', '__return_empty_array' );
add_filter( 'keyword_rewrite_rules', '__return_empty_array' );
add_filter( 'voices_rewrite_rules', '__return_empty_array' );
add_filter( 'instagram_rewrite_rules', '__return_empty_array' );
add_filter( 'database_rewrite_rules', '__return_empty_array' );
//  指定のカスタムタクソノミーのアーカイブページにアセスした際404に飛ばすリライト処理
add_filter( 'catplanner_rewrite_rules', '__return_empty_array' );
add_filter( 'catreports_rewrite_rules', '__return_empty_array' );
add_filter( 'catkeyword_rewrite_rules', '__return_empty_array' );
add_filter( 'catvoice_rewrite_rules', '__return_empty_array' );
add_filter( 'catinsta_rewrite_rules', '__return_empty_array' );
add_filter( 'area_taxonomy_rewrite_rules', '__return_empty_array' );
add_filter( 'plan_tags_taxonomy_rewrite_rules', '__return_empty_array' );
add_filter( 'plancat_taxonomy_rewrite_rules', '__return_empty_array' );
